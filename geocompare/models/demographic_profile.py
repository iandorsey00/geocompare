...
class DemographicProfile:
    ...
    def __init__(self, db_row):
        ...
        # Geography category
        self.rc['land_area'] = parse_float(db_row['ALAND_SQMI'])
        self.rc['latitude'] = parse_float(db_row['INTPTLAT'])
        self.rc['longitude'] = parse_float(db_row['INTPTLONG'])
        self.rc['median_age'] = parse_float(db_row['B01002_1'])

        # Population category
        self.rc['population'] = parse_number(db_row['B01003_1'])
        self.rc['under_18'] = \
            parse_number(db_row['B01001_3']) + parse_number(db_row['B01001_4']) \
            + parse_number(db_row['B01001_5']) + parse_number(db_row['B01001_6']) \
            + parse_number(db_row['B01001_27']) + parse_number(db_row['B01001_28']) \
            + parse_number(db_row['B01001_29']) + parse_number(db_row['B01001_30'])
        self.rc['age_65_plus'] = \
            parse_number(db_row['B01001_20']) + parse_number(db_row['B01001_21']) \
            + parse_number(db_row['B01001_22']) + parse_number(db_row['B01001_23']) \
            + parse_number(db_row['B01001_24']) + parse_number(db_row['B01001_25']) \
        ...
        self.rc['black_alone'] = parse_number(db_row['B02001_3'])
        self.rc['asian_alone'] = parse_number(db_row['B02001_5'])
        self.rc['other_race'] = parse_number(db_row['B01003_1']) \
            - parse_number(db_row['B02001_2']) - parse_number(db_row['B02001_3']) \
            - parse_number(db_row['B02001_5'])
        # Technically not a race, but included in the race category
        self.rc['hispanic_or_latino'] = parse_number(db_row['B03002_12'])
        self.rc['white_alone_not_hispanic_or_latino'] = parse_number(db_row['B03002_3'])

        # Italian
        self.rc['italian_alone'] = parse_number(db_row['B04004_51'])

        # Education category
        self.rc['population_25_years_and_older'] = parse_number(db_row['B15003_1'])
        self.rc['bachelors_degree_or_higher'] = parse_number(db_row['B15003_22']) \
            + parse_number(db_row['B15003_23']) + parse_number(db_row['B15003_24']) \
            + parse_number(db_row['B15003_25'])
        self.rc['graduate_degree_or_higher'] = parse_number(db_row['B15003_23']) \
           + parse_number(db_row['B15003_24']) + parse_number(db_row['B15003_25'])

        # Income category
        self.rc['per_capita_income'] = parse_number(db_row['B19301_1'])
        self.rc['median_household_income'] = parse_number(db_row['B19013_1'])
        self.rc['poverty_universe'] = parse_number(db_row['B17001_1'])
        self.rc['population_below_poverty_level'] = parse_number(db_row['B17001_2'])
        self.rc['labor_force'] = parse_number(db_row['B23025_3'])
        self.rc['unemployed_population'] = parse_number(db_row['B23025_5'])
        self.rc['households'] = parse_number(db_row['B11001_1'])

        # Housing category
        self.rc['average_household_size'] = parse_float(db_row['B25010_1'])
        self.rc['occupied_housing_units'] = parse_number(db_row['B25003_1'])
        self.rc['homeowner_occupied_housing_units'] = parse_number(db_row['B25003_2'])
        self.rc['median_year_structure_built'] = parse_number(db_row['B25035_1'])
        self.rc['median_rooms'] = parse_number(db_row['B25018_1'])
        self.rc['median_value'] = parse_number(db_row['B25077_1'])
        self.rc['median_rent'] = parse_number(db_row['B25058_1'])
